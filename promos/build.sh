...
# Output: promos/out/coinpurse-promo-N.jpg at 1920x1080 (rendered at 2x, downsampled).
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/coinpurse-promo-$n.png" \
  ...
  sips --resampleWidth 1920 -s format jpeg -s formatOptions 90 \
    "out/coinpurse-promo-$n.png" --out "out/coinpurse-promo-$n.jpg" >/dev/null
  rm "out/coinpurse-promo-$n.png"
  echo "  built out/coinpurse-promo-$n.jpg"
done
